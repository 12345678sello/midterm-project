...
class _SwipeScreenState extends State<SwipePage> {
  Color bgColor = const Color.fromARGB(255, 110, 49, 251);
    ...
    setState(() {
      switch (direction) {
        ...
        case "right":
          ...
          break;
        case "up":
          bgColor = const Color.fromARGB(255, 245, 79, 181);
          break;
        case "down":
...
class _MusicPlayerPageState extends State<MusicPlayerPage> {
  ...
  final List<Map<String, String>> songs = [
    {"title": "Palagi", "file": "Palagi.mp3"},
    {"title": "Sa Bawat Sandali", "file": "Sa Bawat Sandali.mp3"}
  ];
  ...
  void initState() {
    ...
    // Makinig sa pagbabago ng duration ng kanta
    _audioPlayer.onDurationChanged.listen((Duration d) {
      setState(() => _duration = d);
    });

    // Makinig sa pagbabago ng posisyon ng kanta
    _audioPlayer.onPositionChanged.listen((Duration p) {
      setState(() => _position = p);
    });

    // Makinig kung tapos na ang kanta, lumipat sa susunod
    _audioPlayer.onPlayerComplete.listen((event) {
      _playNext();
    });
  }

  // Function para sa Play at Pause
  ...
  // Function para lumipat sa susunod na kanta
  void _playNext() {
    setState(() {
  ...
  // Function para lumipat sa naunang kanta
  void _playPrevious() {
    setState(() {
      currentSongIndex = (currentSongIndex - 1) % songs.length;
  ...
  // Function para i-seek ang kanta gamit ang slider
